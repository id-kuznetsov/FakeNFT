...
internal enum L10n {
  internal enum Cart {
    internal enum Button {
      /// К Оплате
      internal static let toPay = L10n.tr("Localizable", "Cart.button.toPay", fallback: "К Оплате")
    }
  }
  ...
  internal enum Tab {
    ...
    /// Статистика
    internal static let statistic = L10n.tr("Localizable", "Tab.statistic", fallback: "Статистика")
  }
}
